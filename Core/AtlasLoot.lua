...
AtlasLoot_DewDropDown = {
	...
	[8] = {
		[AL["Nyctermoon"]] = {
			...
			[7] = { { (AL["Eternal Recipes"]), "Nycter_EternalRecipes", "Submenu" }, },
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["Nycter_Classes"] = {
		{ "|cffffffff"..AL["Priest"], "Nycter_Classes_Priest" },
		-- { "|cff68ccef"..AL["Mage"], "Nycter_Classes_Mage" },
		-- { "|cff9382c9"..AL["Warlock"], "Nycter_Classes_Warlock" },
		-- { "|cfffff468"..AL["Rogue"], "Nycter_Classes_Rogue" },
		-- { "|cffff7c0a"..AL["Druid"], "Nycter_Classes_Druid" },
		{ "|cffaad372"..AL["Hunter"], "Nycter_Classes_Hunter" },
		-- { "|cff2773ff"..AL["Shaman"], "Nycter_Classes_Shaman" },
		-- { "|cfff48cba"..AL["Paladin"], "Nycter_Classes_Paladin" },
		-- { "|cffc69b6d"..AL["Warrior"], "Nycter_Classes_Warrior" },
	},
};
