...
----------------
	...
	EnchantingJourneyman1 = {
		...
		{ "e40608", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Minor Agility", "=ds=#sr# =so1=85 =so2=85 =so3=110 =so4=135" },
		{ "e40638", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Minor Intellect", "=ds=#sr# =so1=85 =so2=85 =so3=110 =so4=135" },
		{ "e40656", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Minor Spirit", "=ds=#sr# =so1=85 =so2=85 =so3=110 =so4=135" },
		...
		{ "e40623", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Minor Agility", "=ds=#sr# =so1=90 =so2=90 =so3=115 =so4=140" },
		...
		{ "e40609", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Lesser Agility", "=ds=#sr# =so1=135 =so2=135 =so3=160 =so4=185" },
		{ "e40639", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Lesser Intellect", "=ds=#sr# =so1=135 =so2=135 =so3=160 =so4=185" },
		{ "e40657", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Lesser Spirit", "=ds=#sr# =so1=135 =so2=135 =so3=160 =so4=185" },
	...
	EnchantingJourneyman2 = {
		...
		{ "e40624", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Lesser Agility", "=ds=#sr# =so1=140 =so2=140 =so3=165 =so4=190" },
		{ "e40650", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Lesser Intellect", "=ds=#sr# =so1=140 =so2=140 =so3=165 =so4=190" },
		{ "e40668", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Lesser Spirit", "=ds=#sr# =so1=140 =so2=140 =so3=165 =so4=190" },
	...
	EnchantingExpert1 = {
		...
		{ "e40610", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Agility", "=ds=#sr# =so1=190 =so2=190 =so3=215 =so4=240" },
		{ "e40640", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Intellect", "=ds=#sr# =so1=190 =so2=190 =so3=215 =so4=240" },
		{ "e40658", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Spirit", "=ds=#sr# =so1=190 =so2=190 =so3=215 =so4=240" },
	...
	EnchantingArtisan1 = {
		...
		{ "e40611", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Greater Agility", "=ds=#sr# =so1=240 =so2=240 =so3=265 =so4=290" },
		{ "e40641", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Greater Intellect", "=ds=#sr# =so1=240 =so2=240 =so3=265 =so4=290" },
		{ "e40659", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Greater Spirit", "=ds=#sr# =so1=240 =so2=240 =so3=265 =so4=290" },
		...
		{ "e40626", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Greater Agility", "=ds=#sr# =so1=245 =so2=245 =so3=270 =so4=295" },
		...
		{ "e40675", "Spell_Holy_GreaterHeal", "=mb=Enchant Gloves - Greater Intellect", "=ds=#sr# =so1=270 =so2=290 =so3=310 =so4=330" },
	...
	EnchantingArtisan3 = {
		...
		{ "e40612", "Spell_Holy_GreaterHeal", "=mb=Enchant Weapon - Major Agility", "=ds=#sr# =so1=300 =so2=320 =so3=345 =so4=370" },
		{ "e40627", "Spell_Holy_GreaterHeal", "=mb=Enchant 2H Weapon - Major Agility", "=ds=#sr# =so1=300 =so2=325 =so3=350 =so4=375" },
		{ "e40676", "Spell_Holy_GreaterHeal", "=mb=Enchant Gloves - Superior Intellect", "=ds=#sr# =so1=300 =so2=320 =so3=340 =so4=360" },
	};
...
---------------------
	...
	SmithingExpert1 = {
		...
		{ "s3494", "inv_hammer_07", "=q2=soid Iron Maul", "=ds=#sr# =so1=155 =so2=180 =so3=192 =so4=205" },
		...
		{ "s9920", "inv_stone_grindingstone_04", "=q1=soid Grinding Stone", "=ds=#sr# =so1=200 =so2=200 =so3=205 =so4=210" },
		{ "s9918", "inv_stone_sharpeningstone_04", "=q1=soid Sharpening Stone", "=ds=#sr# =so1=200 =so2=200 =so3=205 =so4=210" },
	};

	SmithingExpert2 = {
		{ "s9921", "inv_stone_weightstone_04", "=q1=soid Weightstone", "=ds=#sr# =so1=200 =so2=200 =so3=205 =so4=210" },
...
-----------------
	...
	EngineeringExpert1 = {
		...
		{ "s12585", "inv_misc_powder_black", "=q1=soid Blasting Powder", "=ds=#sr# =so1=175 =so2=175 =so3=185 =so4=195" },
		{ "s12586", "inv_misc_bomb_06", "=q1=soid Dynamite", "=ds=#sr# =so1=175 =so2=175 =so3=185 =so4=195" },
